...
const bonuses = [
  { title: "Mermeladas Artesanales", label: "BONO 01", value: "$17.000", image: "/images/bonuses/04-produciendo-mermeladas.jpg", description: "Amplía tu repertorio aprendiendo a preparar mermeladas artesanales con diferentes sabores, texturas y presentaciones." },
