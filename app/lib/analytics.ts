...
export async function getStats(targetDate?: string) {
  ...
  return {
    total: {
      ...
      checkoutViewsCompleta: count("checkout_view_completa") + count("checkout_view_completa_75off"),
      ...
      paymentsApprovedCompleta: events.filter((e) => e.type === "payment_approved" && (e.metadata?.edition === "completa" || e.metadata?.edition === "completa_75off")).length,
    ...
    today: {
      ...
      checkoutViewsCompleta: countToday("checkout_view_completa") + countToday("checkout_view_completa_75off"),
      ...
      paymentsApprovedCompleta: todayEvents.filter((e) => e.type === "payment_approved" && (e.metadata?.edition === "completa" || e.metadata?.edition === "completa_75off")).length,
